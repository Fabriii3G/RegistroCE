...
msgNombreInv db 0Dh,0Ah,'Entrada invalida: debe ingresar Nombre y dos Apellidos antes de la nota.',0Dh,0Ah,'$'

; --- indices/valores internos para acceso rapido ---
recOfs        dw 15 dup(0)        ; offset dentro de studentsBuf de cada registro
notas32       dd 15 dup(0)        ; nota escalada *10^5 (32 bits)
fracVal       dw 0                ; acumulador parte fraccionaria (0..99999)

; tabla potencias 10 para completar a 5 decimales: 10^(5-n)
; indexar con decCount en [0..5] ? usa (5-decCount)
pow10         dw 100000/10, 10000, 1000, 100, 10, 1
; Nota: 100000 no cabe en 16 bits, por eso usamos 10000 y multiplicamos aparte
; ver secci�n de c�mputo abajo.
 


; --- Opcion 3 (buscar por ?ndice) ---
...
; Buffer para leer un numero corto con AH=0Ah (max 3 d?gitos)
